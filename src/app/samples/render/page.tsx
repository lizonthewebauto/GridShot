...
const CREATORS: Creator[] = [
  ...
  },
  {
    ...
    bodyText: 'A fun 90-minute portrait shoot made to help you love how you look on camera. We handle the styling, the posing, and the editing. You walk away with 40 retouched photos ready to use.',
    photoUrl: '/samples/portrait-woman.jpg',
    photos: ['/samples/portrait-woman.jpg', '/samples/portrait-man.jpg', '/samples/portrait-woman.jpg', '/samples/portrait-man.jpg'],
    tagline: 'Personal brand portraits',
  },
  {
    slug: 'realestate',
    brandName: 'Apex Visuals',
    colors: { primary: '#0f1f2e', secondary: '#fafafa', accent: '#c47e3c' },
    ...
    photoUrl: '/samples/realestate-living.jpg',
    photos: ['/samples/realestate-living.jpg', '/samples/realestate-kitchen.jpg', '/samples/realestate-interior.jpg', '/samples/realestate-living.jpg'],
  ...
  },
  {
    ...
    photoUrl: '/samples/food-plating.jpg',
    photos: ['/samples/food-plating.jpg', '/samples/food-pasta.jpg', '/samples/food-dessert.jpg', '/samples/food-flatlay.jpg'],
  ...
  },
  {
    ...
    photos: ['/samples/travel-temple.jpg', '/samples/travel-japan.jpg', '/samples/travel-mountain.jpg', '/samples/travel-temple.jpg'],
    tagline: 'Travel photography prints',
  },
  {
    slug: 'newborn',
    brandName: 'Juniper Studio',
    colors: { primary: '#f4e4e8', secondary: '#3d2a3a', accent: '#b5739a' },
    fontHeading: 'Caveat',
    fontBody: 'Inter',
    headline: 'Hello, Little One',
    bodyText: 'Those first two weeks go so fast. We come to your home, on your schedule, and capture the quiet moments that disappear before you know it. Sessions book three months out.',
    photoUrl: '/samples/newborn.jpg',
    photos: ['/samples/newborn.jpg', '/samples/maternity.jpg', '/samples/newborn.jpg', '/samples/maternity.jpg'],
    tagline: 'Newborn + maternity sessions',
  },
  {
    slug: 'fashion',
    brandName: 'Prima Atelier',
    colors: { primary: '#0f0f0f', secondary: '#f2efe9', accent: '#ff2d6b' },
  ...
  },
  {
    ...
    colors: { primary: '#e8dccd', secondary: '#2b2520', accent: '#c44a2c' },
  ...
  {
    slug: 'family',
    brandName: 'Goldenhour Co',
    colors: { primary: '#2a1a10', secondary: '#fbe4c7', accent: '#e38a2a' },
    fontHeading: 'Amatic SC',
    fontBody: 'DM Sans',
    headline: 'The Sanchez Family',
    bodyText: 'We spent a Saturday on the beach with the Sanchez family. Little feet in the sand, the dog running off with a shoe, and a sunset that lasted forever. Book your family session now.',
    photoUrl: '/samples/family-beach.jpg',
    photos: ['/samples/family-beach.jpg', '/samples/family-beach.jpg', '/samples/couple-engagement.jpg', '/samples/family-beach.jpg'],
